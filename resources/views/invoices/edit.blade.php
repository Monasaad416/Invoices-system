                    ...
                    <form action="{{ route('invoices.update',$invoice) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number" value="{{$invoice->invoice_number}}" title="Pl" >
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_date" value="{{$invoice->invoice_date}}" placeholder="YYYY-MM-DD" type="text" value="{{ date('Y-m-d') }}" >
                            </div>
                            @error('invoice_date')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="due_date" value="{{$invoice->due_date}}"  placeholder="YYYY-MM-DD" type="text">
                            </div>
                            @error('due_date')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" value="{{$invoice->product->id}}" name="product_id" class="form-control">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="custom_button">Update</button>
                        </div>
                    </form>
                </div>
            </div>
