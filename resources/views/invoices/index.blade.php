					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class=" d-inline-flex justify-content-around mt-5">
								<div><button class="custom_button"><a class="custom_link" href="{{route('invoices.create')}}">Add Invoice</a></button></div>
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
                                                ...
                                                <th class="border-bottom-0">Statues</th>
										...
										<tbody>
											@foreach($invoices as $invoice)
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                              ...
                                                              data-toggle="modal"
                                                              data-effect="effect-flip-vertical"
                                                              data-target="#archive{{ $invoice->id }}" title="Archive Invoice">
                                                              <i class="fa fa-archive mx-1" aria-hidden="true"></i> Archive Invoice
                                                            </a>
                                                            <a class="dropdown-item" href="{{route('print_invoice',['invoice_id'=>$invoice->id])}}"><i class="fa fa-print mx-1" aria-hidden="true"></i>Print Invoice</a>
                                                          </div>
                                                    </td>
												</tr>
                                                ...
                                                <!--Archive Modal End-->
                                                <div class="modal" id="archive{{$invoice->id}}">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content modal-content-demo">
                                                            <div class="modal-header">
                                                                                        ...
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="{{route('invoices.destroy',$invoice)}}">
                                                                                                    @csrf
                                                                                                        {{ method_field('delete') }}
                                                                                                    <p class="text-danger font-weight-bold my-3">Are you sure you want to archive invoice number {{$invoice->invoice_number}} ?</p>
                                                                                                    <input class="form-control" name="invoice_id" value="{{$invoice->id}}" type="hidden">
                                                                                                    <input class="form-control" name="archive_invoice" value="archive" type="hidden">
                                                                                                    <div class="modal-footer">
                                                                                                        <button class="btn ripple btn-secondary" data-dismiss="modal" type="button">Close</button>
                                                                                                        <button type="submit" class="btn btn-danger pd-x-20">Archive</button>
                                                                                                    </div>
                                                                                                </form>
                                                                                            </div>
                                                                                        </div>
