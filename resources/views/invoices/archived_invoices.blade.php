...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Archived Invoices</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											@foreach($archived_invoices as $invoice)
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                ...
                                                                data-target="#restore{{ $invoice->id }}" title="Restore Invoice">
                                                                <i class="fa fa-window-restore text-success" aria-hidden="true"></i> Restore Invoice
                                                              </a>
                                                              <a class="dropdown-item" href="#" class="modal-effect text-danger btn-sm"
                                                                data-toggle="modal"
                                                                data-effect="effect-flip-vertical"
                                                ...
                                                <!--Restore Modal start-->
                                                <div class="modal" id="restore{{$invoice->id}}">
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="{{url("/restore_archived_invoice/$invoice->id")}}">
                                                                                                    @csrf
                                                                                                    <p class="text-info font-weight-bold my-3">Are you sure you want to restore invoice number {{$invoice->invoice_number}}</p>
                                                                                                    <input class="form-control" name="invoice_id" value="{{$invoice->id}}" type="hidden">
                                                                                                    <div class="modal-footer">
                                                                                                        <button class="btn ripple btn-secondary" data-dismiss="modal" type="button">Close</button>
                                                                                                        <button type="submit" class="btn btn-info pd-x-20">Restore</button>
                                                                                                    </div>
                                                                                                </form>
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="{{route('invoices_archive.destroy',$invoice)}}">
                                                                                                    @csrf
                                                                                                     {{ method_field('delete') }}
