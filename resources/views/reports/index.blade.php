        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('search_invoices')}}" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="search_type" type="radio" value="1" id="with_type_search" > <span>Search with invoice type</span>
                        </label>
                    </div>
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox">
                            <input name="search_type" value="2" type="radio"  id="with_invoice_no"><span>Search with invoice number</span>
                        </label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">Select invoice type</p><select class="form-control select2" name="type"
                                required>
                                <option value="Select invoivce type" selected>
                                   ---Select invoivce type
                                </option>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('input[type="radio"]').click(function(){
            if($(this).attr('id') == 'with_invoice_no') {
                $("#type").hide();
                $("#start_at").hide();
                $("#end_at").hide();
                $('#invoice_number').show();
